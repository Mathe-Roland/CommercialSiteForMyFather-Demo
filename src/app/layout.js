  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel='preload' fetchPriority='high' href={`${cloudinaryTransformation(`https://res.cloudinary.com/ddrkdrrre/image/upload/v1721761368/szobasfafeketer_adfc03d26d.png`,250,250)}`} as="image"></link>
      </head>
